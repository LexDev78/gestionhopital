                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-lg">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                        <td class="text-bold-500">{{$operations->user->nom." ".$operations->user->prenom}}</td>
                                                        <td class="text-bold-500">{{$operations->patient->nom." ".$operations->patient->prenom}}</td>
                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input  list="user_id" name="user_id" class="form-control">
                                            <datalist id="user_id">
                                                @foreach($users as $user)
                                                    <option value="{{$user->id}}">{{$user->username}}</option>
                                                @endforeach
