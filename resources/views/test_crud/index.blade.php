                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <p class="card-text">Pour <a href="" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#testAdd">insérer un nouvelle ligne</a></p>
                                        ...
                                        <table class="table table-lg">
                                            ...
                                            <tbody>
                                                ...
                                                <td>
                                                    ...
                                                    data-bs-target="#testUpdate{{$test->id}}" href="#">
                                                    Modifier
                                                </a>
                                            </td>
                                            <td>
                                                <a class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#testDestroy{{$test->id}}" href="#">
                                                Supprimer
                                            </a>
                                        </td>
                                    </tr>
                            ...
                            <!-- Boite modale pour la modification des visites-->
                             <div class="modal fade admin-query" id="testUpdate{{$test->id}}"
                                ...
                                <div class="modal-dialog" role="document">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-icon-left">
                                                                <div class="position-relative">
                                                                    ...
                                                                    class="form-control" value="{{ $test->nom }}" placeholder="Nom !...">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-icon-left">
                                                                <div class="position-relative">
                                                                    ...
                                                                    class="form-control" value="{{ $test->prix }}" placeholder="Prix!...">
                                                                    <div class="form-control-icon">
                                                                        <i class="bi bi-pencil"></i>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="modal fade admin-query" id="testDestroy{{$test->id}}"
                                        data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true"
                                        role="dialog" tabindex="-1">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
