...
<section class="section">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Prescription enregistrés</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <p class="card-text">Pour <a href="" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#prescriAdd">insérer un nouvelle ligne</a></p>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-lg">
                                            ...
                                            <tbody>
                                                @forelse ($prescris as $prescri)
                                                <tr>
                                                        <td class="text-bold-500">{{$prescri->libelle}}</td>
                                                        <td class="text-bold-500">{{$prescri->user->nom}}</td>
                                                        <td class="text-bold-500">{{$prescri->patient->nom}}</td>
                                                        {{-- <td class="text-bold-500">{{$prescri->prix}}</td> --}}
                                                        <td>
                                                    </td>
                                                ...
                                                <td>
                                                    ...
                                                    data-bs-target="#prescriUpdate{{$prescri->id}}" href="#">
                                                    Modifier
                                                </a>
                                            </td>
                                            <td>
                                                <a class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#prescriDestroy{{$prescri->id}}" href="#">
                                                Supprimer
                                            </a>
                                        </td>
                                    </tr>
                            ...
                            <!-- Boite modale pour la modification des visites-->
                             <div class="modal fade admin-query" id="prescriUpdate{{$prescri->id}}"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p class="text-wrap">
                                                <form method="POST"
                                                action="{{route('prescri.update', $prescri->id)}}"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-icon-left">
                                                                <div class="position-relative">
                                                                    ...
                                                                    class="form-control" value="{{ $prescri->libelle }}" placeholder="Libelle !...">
                                    ...
                                    <div class="modal fade admin-query" id="prescriDestroy{{$prescri->id}}"
                                        data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true"
                                        role="dialog" tabindex="-1">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p class="text-wrap">
                                                        <form action="{{route('prescri.destroy', $prescri->id)}}"
                                                            method="POST">
                                                            @method("DELETE")
                                                            @csrf
                                                            <div class="form-body">
    ...
    <div class="modal fade admin-query" id="prescriAdd" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true"
    role="dialog" tabindex="-1">
    <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <p class="text-wrap">
                ...
                <form method="POST" action="{{route('prescri.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <div class="row">
